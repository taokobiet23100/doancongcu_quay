<?php
// piano.php - Hiển thị danh sách Piano (loaiDan_id = 1)
include __DIR__ . '/header.php';
$apiUrl = 'http://localhost/DoAnPHP/controller/InstrumentController.php?loaiDan_id=1';
$response = file_get_contents($apiUrl);
$instruments = json_decode($response, true);
?>

<div class="container my-4">
    <h2 class="text-center">Danh Sách Piano</h2>
    <div class="row">
